For a better README, visit https://github.com/yumeShinoA/cs121_A3

Simple Search Engine
This is a basic search engine that builds an inverted index and computes PageRank scores from a collection of JSON files. 
It uses TF-IDF and cosine similarity combined with PageRank to rank search results. A local GUI is provided to enter queries and view results.
...
Then run the main indexing script to build the following Output files:
